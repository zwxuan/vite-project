...
import { DataPermissionItemProps } from '@/types/dynamic_configuration_platform/identity/role_manage';
import {getDataPermissionList} from '@/api/dynamic_configuration_platform/identity/role_manage_service';
