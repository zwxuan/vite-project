...
import { BaseAmsPortItemProps } from "@/types/dynamic_onfiguration_platform/basic_manage/base_ams_port";
import { getBaseAmsPortList } from "@/api/dynamic_onfiguration_platform/basic_manage/base_ams_port_service";
...
const AMSPortComponent : React.FC = () => {
    ...
    useEffect(() => {
        const getData = async () => {
            const invoiceData = await getBaseAmsPortList();
            // 设置发票管理台账数据
