                ...
                <div className="header-title-search-area">
                    <div className="BillHeadInfoWrap BillHeadInfoWrap-showBackBtn">
                        <span className="bill-info-title" style={{marginLeft: "10px"}}>
                            <CustomIcon type="icon-Currency"  style={{color:'red',fontSize:'24px'}} /> 币种
                            <Tooltip
                                title={
                                    <div className='rul_title_tooltip' style={{ backgroundColor: '#fff', color: '#000' }}>
                                        <ol style={{ color: '#666666', fontSize: '12px', paddingLeft: '2px' }}>
                                            ...
                                            当企业业务涉及到国际贸易时，就会需要用到多币种。系统中的多币种应用特性如下：
                                            <p>①不同的交易对象、不同的业务敏感的币种不同；</p>
                                            <p>②不同交易币种，金额和单价的显示符号不同；</p>
                                            <p>③不同货币最小面值不同，所以交易过程中，单价和金额的最小位及舍入规则也不同；</p>
                                            <p>④对于同一种货币，表示单价和表示金额的时候，需要的精度也不同。比如人民币中，商品单价可能会精确到小数点后三或者四位，但确定金额时可能只精确到小数点后两位。</p>
                                            </li>
                                        </ol>
                                    </div>
                                }
