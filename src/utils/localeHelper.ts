...
class LocaleHelper {
    ...
    // 业务编号
    static getOrdersBusinessId() {
      return "orders.businessid";
    }
    // 主单号
    static getOrdersMainOrderNumber() {
      return "orders.mainordernumber";
    }
    // 承运人名称
    static getOrdersCarrier() {
      return "orders.carrier";
    }
    // 船名
    static getOrdersShipName() {
      return "orders.shipname";
    }
    // 航次
    static getOrdersVoyage() {
      return "orders.voyage";
    }
    // 客户名称
    static getOrdersCustomer() {
      return "orders.customer";
    }
    // 业务日期
    static getOrdersBusinessDate() {
      return "orders.businessdate";
    }
    // 合约状态
    static getOrdersContractStatus() {
      return "orders.contractstatus";
    }
    // 起运港
    static getOrdersDeparturePort() {
      return "orders.departureport";
    }
    // 目的港
    static getOrdersDestinationPort() {
      return "orders.destinationport";
    }
    // 开航日期
    static getOrdersDepartureDate() {
      return "orders.departuredate";
    }
    // 客服名称
    static getOrdersCustomerService() {
      return "orders.customerservice";
    }
    // 空运制单计费重量
    static getOrdersAirWaybillChargedWeight() {
      return "orders.airwaybillchargedweight";
    }
    // 空运订舱计费重量
    static getOrdersAirBookingChargedWeight() {
      return "orders.airbookingchargedweight";
    }
    // 订/换单窗口
    static getOrdersBookingAgent() {
      return "orders.bookingagent";
    }
    // 项目编号
    static getOrdersProjectId() {
      return "orders.projectid";
    }
    // 操作
    static getOrdersOperation() {
      return "orders.operation";
    }
    // 销售人员
    static getOrdersSales() {
      return "orders.sales";
    }
    // 销售部门
    static getOrdersSalesDepartment() {
      return "orders.salesdepartment";
    }
    // 海外客服
    static getOrdersOverseasService() {
      return "orders.overseasservice";
    }
    // 状态
    static getOrdersStatus() {
      return "orders.status";
    }
    // 业务类型
    static getOrdersBusinessType() {
      return "orders.businesstype";
    }
    // 实际计费重量
    static getOrdersActualChargedWeight() {
      return "orders.actualchargedweight";
    }
    // 委托件数
    static getOrdersEntrustedPieces() {
      return "orders.entrustedpieces";
    }
    // 箱号
    static getOrdersContainerNumber() {
      return "orders.containernumber";
    }
    // 委托毛重
    static getOrdersEntrustedGrossWeight() {
      return "orders.entrustedgrossweight";
    }
    // 委托体积
    static getOrdersEntrustedVolume() {
      return "orders.entrustedvolume";
    }
    // 实际件数
    static getOrdersActualPieces() {
      return "orders.actualpieces";
    }
    // 实际毛重
    static getOrdersActualGrossWeight() {
      return "orders.actualgrossweight";
    }
    // 实际体积
    static getOrdersActualVolume() {
      return "orders.actualvolume";
    }
    // 应付核销状态
    static getOrdersPayableVerificationStatus() {
      return "orders.payableverificationstatus";
    }
    // 应收核销状态
    static getOrdersReceivableVerificationStatus() {
      return "orders.receivableverificationstatus";
    }
    // 买价
    static getOrdersPurchasePrice() {
      return "orders.purchaseprice";
    }
    // 卖价
    static getOrdersSellingPrice() {
      return "orders.sellingprice";
    }
    // 到港日期
    static getOrdersArrivalDate() {
      return "orders.arrivaldate";
    }
    // 指定货代理
    static getOrdersDesignatedFreightAgent() {
      return "orders.designatedfreightagent";
    }
    // 最终目的地
    static getOrdersFinalDestination() {
      return "orders.finaldestination";
    }
    // 本地服务
    static getOrdersLocalService() {
      return "orders.localservice";
    }
    // 创建日期，默认当前日期时间
    static getOrdersCreationDate() {
      return "orders.creationdate";
    }
    // 自定义业务类型
    static getOrdersCustomBusinessType() {
      return "orders.custombusinesstype";
    }
    // 业务参考号
    static getOrdersBusinessReferenceNumber() {
      return "orders.businessreferencenumber";
    }
    // 送货日期
    static getOrdersDeliveryDate() {
      return "orders.deliverydate";
    }
    // 船公司约号
    static getOrdersShippingCompanyContractNumber() {
      return "orders.shippingcompanycontractnumber";
    }
    // 内部约号
    static getOrdersInternalContractNumber() {
      return "orders.internalcontractnumber";
    }
    // 报价单号
    static getOrdersQuotationNumber() {
      return "orders.quotationnumber";
    }
    // 航线
    static getOrdersShippingRoute() {
      return "orders.shippingroute";
    }
    // TEU（标准箱数）
    static getOrdersTeu() {
      return "orders.teu";
    ...
    // 箱型箱量
    static getOrdersContainerTypeQuantity() {
      return "orders.containertypequantity";
    }
    // 揽货销售
    static getOrdersCollectionSales() {
      return "orders.collectionsales";
    }
    // 操作日期
    static getOrdersOperationDate() {
      return "orders.operationdate";
    }
    // 实际开航日期
    static getOrdersActualDepartureDateAtd() {
      return "orders.actualdeparturedateatd";
    }
    // 实际到港日期
    static getOrdersActualArrivalDateAta() {
      return "orders.actualarrivaldateata";
    }
    // 收货人
    static getOrdersConsignee() {
      return "orders.consignee";
    }
    // 发货人
    static getOrdersShipper() {
      return "orders.shipper";
    }
    // 应收开票状态
    static getOrdersReceivableInvoiceStatus() {
      return "orders.receivableinvoicestatus";
    }
    // 应付开票状态
    static getOrdersPayableInvoiceStatus() {
      return "orders.payableinvoicestatus";
    }
    // 客户联系人
    static getOrdersCustomerContact() {
      return "orders.customercontact";
    }
    // SOP状态
    static getOrdersSopStatus() {
      return "orders.sopstatus";
    }
    // SOP模板名称
    static getOrdersSopTemplateName() {
      return "orders.soptemplatename";
    }
    // 货物类型
    static getOrdersCargoType() {
      return "orders.cargotype";
    }
    // 实际提重时间
    static getOrdersActualPickupTime() {
      return "orders.actualpickuptime";
    }
    // 实际还空时间
    static getOrdersActualReturnEmptyTime() {
      return "orders.actualreturnemptytime";
    }
    // 分单号
    static getOrdersSubOrderNumber() {
      return "orders.subordernumber";
    }
    // 客户级别
    static getOrdersCustomerLevel() {
      return "orders.customerlevel";
    }
    // 实际送货时间
    static getOrdersActualDeliveryTime() {
      return "orders.actualdeliverytime";
    }
    // 客服部门
    static getOrdersCustomerServiceDepartment() {
      return "orders.customerservicedepartment";
    }
    // 单证部门
    static getOrdersDocumentationDepartment() {
      return "orders.documentationdepartment";
    }
    // 应收费用是否录入
    static getOrdersReceivableFeesEntered() {
      return "orders.receivablefeesentered";
    }
    // 应付费用是否录入
    static getOrdersPayableFeesEntered() {
      return "orders.payablefeesentered";
    }
    // 支线开航日期
    static getOrdersBranchDepartureDate() {
      return "orders.branchdeparturedate";
    }
    // 支线到港日期
    static getOrdersBranchArrivalDate() {
      return "orders.brancharrivaldate";
    }
    // 驳车发运日期
    static getOrdersBargeDepartureDate() {
      return "orders.bargedeparturedate";
    }
    // 驳车抵运日期
    static getOrdersBargeArrivalDate() {
      return "orders.bargearrivaldate";
    }
    // 唛头
    static getOrdersMark() {
      return "orders.mark";
    }
    // 进场时间
    static getOrdersEntryTime() {
      return "orders.entrytime";
    }
    // 揽货类型
    static getOrdersCollectionType() {
      return "orders.collectiontype";
    }
    // 利润
    static getOrdersProfit() {
      return "orders.profit";
    }
    // 收入
    static getOrdersIncome() {
