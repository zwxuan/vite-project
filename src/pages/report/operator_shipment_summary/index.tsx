...
const OperatorShipmentSummaryReport: React.FC = () => {
    ...
    useEffect(() => {
        const loadData = async () => {
            try {
                const response = await fetch('/data/operator_shipment_summary_data.json');
                if (!response.ok) {
    ...
    const s2DataConfig: S2DataConfig = {
        fields: {
            rows: ["business_operator", "customer_service", "container_type_and_quantity"],
            columns: [],
            values: ["ticket_count", "teu", "rmb_receivable", "rmb_payable", "rmb_profit", "usd_receivable", "usd_payable", "usd_profit", "total_income", "total_cost", "total_profit"],
            valueInCols: true
        },
        meta: [
            {
                field: "business_operator",
                name: "业务操作员"
            },
            {
            ...
            {
                field: "container_type_and_quantity",
                name: "箱型箱量"
            },
            {
                field: "ticket_count",
    ...
    const s2Options: SheetComponentOptions = {
        ...
        totals: {
            row: {
                ...
                subTotalsDimensions: ["business_operator", "customer_service", "container_type_and_quantity"],
            },
                ...
                <div className="header-title-search-area">
                    <div className="BillHeadInfoWrap BillHeadInfoWrap-showBackBtn">
                        <span className="bill-info-title" style={{ marginLeft: "10px" }}>
                            <CustomIcon type="icon-Currency" style={{ color: 'red', fontSize: '24px' }} /> 操作员票数箱量利润汇总表
                        </span>
                    </div>
...
export default OperatorShipmentSummaryReport;
