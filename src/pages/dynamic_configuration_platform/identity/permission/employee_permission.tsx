...
const EmployeePermission: React.FC = () => {
    ...
    // 分配角色
    const handleAssignRole = (record: EmployeeManageItemProps) => {
        setEmployeeCodes([record.EmployeeCode]);
        setOpenAssignRole(true);
    };

    // 用户表格行点击事件
    const handleEmployeeRowClick = (record: EmployeeManageItemProps) => {
    ...
    const columnsEmployeeType = getEmoloyeeColumnsLeft(handleAssignRole, handleEmployeeDelete);
                ...
                <Col span={12}>
                    ...
                    >
                        <Table<EmployeeManageItemProps>
                            ...
                            onRow={(record) => ({
                                onClick: () => handleEmployeeRowClick(record),
                            })}
                            pagination={{
                                size: 'small',
                                pageSize: pageSize,
