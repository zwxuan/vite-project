...
const InvoiceDetail: React.FC = () => {
  ...
  return (
    <div className="invoice-container" style={{overflowY: 'auto',overflowX:'hidden', height: 'calc(100vh - 80px)'}}>
      {/* 头部信息 */}
      <div className="invoice-header">
        <Title level={4}>上海增值税普通发票</Title>
        <Row gutter={24}>
          <Col span={8}>发票号：</Col>
          <Col span={8}>开票日期：2020-09-11</Col>
          <Col span={8}>状态：未导出</Col>
        </Row>
      </div>
      ...
      {/* <Row gutter={[24,0]} className="company-info">
        <Col span={24} className='company-info-left'>
          按钮
        </Col>
      </Row>
      <Row gutter={[24,0]} className="company-info">
      ...
      <Row gutter={24} className="company-info">
        <Col span={6} className='company-info-left'>
          <Input addonBefore="价税合计（大写）" value="伍万陆仟元整" />
        </Col>
        <Col span={18} className='company-info-left'>
          <Input addonBefore="小写" value="¥56,000.00" />
        </Col>
      </Row>
      <Row gutter={[24,0]} className="company-info">
        <Col span={2} className='company-info-left'>
         1
        </Col>
        <Col span={10} className='company-info-left'>
          2
        </Col>
        <Col span={2} className='company-info-left'>
          3
