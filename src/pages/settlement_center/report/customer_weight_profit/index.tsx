...
import { CustomColHeadCell,CustomRowHeadCell,CustomCornerCell,CustomDataCell, customTheme } from '../custom_col_cell';
...
const CustomerWeightProfitReport: React.FC = () => {
    ...
    useEffect(() => {
        const loadData = async () => {
            try {
                const response = await fetch('/data/customer_weight_profit_data.json');
                if (!response.ok) {
    ...
    const s2DataConfig: S2DataConfig = {
        fields: {
            rows: ["customer_name"],
            columns: [],
            values: ["20'GP", "40'GP", "40'HC", "45'GP", "20'OT", "40'OT", "20'FR", "20'RF", "40'FR", "40'RF", "20'TK", "40'TK","TEU", "rmb_profit", "usd_profit", "total_profit", "ticket_number"],
            valueInCols: true
          },
          meta: [
            {
                ...
                <div className="header-title-search-area">
                    <div className="BillHeadInfoWrap BillHeadInfoWrap-showBackBtn">
                        <span className="bill-info-title" style={{ marginLeft: "10px" }}>
                            <CustomIcon type="icon-Currency" style={{ color: 'red', fontSize: '24px' }} /> 客户箱量利润汇总表
                        </span>
                    </div>
...
export default CustomerWeightProfitReport;
