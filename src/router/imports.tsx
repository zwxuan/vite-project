...
const Currency = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/dic_manage/currency"));
...
const PermissionManagement = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/identity/permission"));
...
const VoucherGroupingRule = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/voucher/voucher_grouping_rule"));
const EntryGroupingRule = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/voucher/entry_grouping_rule"));
const AccountingBook = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/voucher/accounting_book"));
const SummaryRule = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/voucher/summary_rule"));
const VoucherType = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/voucher/voucher_type"));
const VoucherCodeMapping = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/voucher/code_mapping"));
const AccountMapping = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/voucher/account_mapping"));
...
const BaseGoods = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/dic_manage/base_goods"));
const BaseSeaPort = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/dic_manage/sea_port"));
const BaseAirPort = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/dic_manage/air_port"));
const BaseRailwayPort = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/dic_manage/base_railway_port"));
const BaseExchangeRate = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/base_exchange_rate"));
const BaseTaxRate = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/base_tax_rate"));
const BaseSettlementMethod = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/base_settlement_method"));
const BaseTradeLanes = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/dic_manage/base_trade_lanes"));
const BaseTradeLanesGrouping = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/dic_manage/base_trade_lanes_grouping"));
const BaseShipmentType = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/dic_manage/base_shipment_type"));
const BaseBusinessType = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/dic_manage/base_business_type"));
const BaseTransportationTerms = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/dic_manage/base_transportation_terms"));
const BaseTradeTerms = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/dic_manage/base_trade_terms"));
const BaseFreightTerms = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/dic_manage/base_freight_terms"));
const BaseBillTerms = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/dic_manage/base_bill_terms"));
const BaseContainerTeu = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/dic_manage/base_container_teu"));
const BaseCargoType = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/dic_manage/base_cargo_type"));
const BaseContainerType = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/dic_manage/base_container_type"));
const ContractsManage = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/contracts_manage"));
const BusinessPartner = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/business_partner"));
const ParterDetail = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/business_partner/detail"));
const InternalAgentSettlement = React.lazy(() => import("@/pages/settlement_center/cost_manage/internal_agent_settlement"));
const PartnerPerformance = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/partner_performance"));
const ContainerLoading = React.lazy(() => import("@/pages/settlement_center/system_manage/container_loading/ContainerLoading"));
const CustomerLevel = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/dic_manage/customer_level"));
const CustomerType = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/dic_manage/customer_type"));
const CustomerIndustry = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/basic_manage/dic_manage/customer_industry"));
const ManageOrg = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/org_manage/manage_org"));
const ManageOrgDetail = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/org_manage/manage_org/detail"));
const AdminOrg = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/org_manage/admin_org"));
const AdminOrgDetail = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/org_manage/admin_org/detail"));
const Department = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/org_manage/department/department"));
const JobPosition = React.lazy(() => import("@/pages/dynamic_onfiguration_platform/org_manage/job_position"));
...
export {
  ...
  ChainMap,AdminOrgDetail,ManageOrgDetail,Department,JobPosition,EmployeeCategory,EmployeeManage,EmployeeManageDetail,MenuManage,RoleManage,RoleManageDetail,
};